// show/carousel.js - Carruseles y agrupaciones
import { createStandardCard, createVerticalCard, createVideoExpand, createListItem } from './cards.js';
import { DATA } from './utils.js';

export function createCarousel(title, type, items, categoryContext, viewAllType = 'category') {
...
export function createSeriesCarousel() {
...
export function createRecommendedCarousel(currentEp) {
    if (!currentEp) return '';
    const similar = DATA
